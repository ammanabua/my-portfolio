        ...
        <section id="about">
            <div className="container-fluid flex flex-col md:flex-row h-screen mx-auto px-10 items-center bg-gray-200">
                <div className="flex flex-col lg:flex-grow md:w-1/2 lg:pl-24 md:pr-16 md:items-start md:text-left mb-16 md:mb-0  items-center">
                    ...
                    <h1 className="title-font text-5xl md:text-6xl mb-4 font-medium text-indigo-900">Amman</h1>
                    ...
                    <div className="flex justify-center">
                        <a
                        href="#contact"
                        className="text-white bg-blue-900 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded text-lg">
                        Hire Me
                        </a>
                        <a
                        href="#projects"
