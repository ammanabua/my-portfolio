  ...
  return (
    <section id='home' className="flex flex-col md:flex-row h-screen md:py-4 items-center justify-center bg-black">
      ...
      <div className='flex flex-col items-center lg:flex-grow md:w-1/2 md:pl-12 lg:pl-24 md:items-start md:text-left mb-16 md:mb-0 md:justify-end'>
        <motion.h1 initial={{ opacity: 0 }} animate={{ opacity:1 }} className="title-font font-mont font-bold text-4xl md:text-7xl mb-4 text-gray-600 uppercase">A<span className='text-blue-600'>m</span>man<br/>Ab<span className='text-yellow-400'>u</span>a<span className='text-yellow-500'>.</span></motion.h1>
        <h3 className="title-font text-2xl md:text-4xl mb-6 font-thin"><span className="title-font text-white" ref={textRef}></span></h3>
